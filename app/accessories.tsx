...
const AccessoriesScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <ScreenHeader title="Accessories" showCart />
      ...
      {loading ? (
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.grid}>
          {items.map((item) => {
            ...
            const category = item.custom_category || item.category || "";
            return (
              <TouchableOpacity
                key={item.id}
                style={styles.card}
              ...
              >
                ...
                <View style={styles.info}>
                  ...
                  {item.sellerName ? (
                    ...
                    <Text style={styles.sellerName} numberOfLines={1}>{category}</Text>
                  ) : null)}
