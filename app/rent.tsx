...
const RentScreen = () => {
  ...
  const handleAddToCart = (item: any) => {
    const payload = {
      ...
      rent_price: item.rent_price ?? undefined, listing_type: item.listing_type,
  ...
  return (
    <View style={styles.container}>
      <ScreenHeader title="Rent" showCart />
      ...
      <ConfirmationModal
        ...
        title="Replace cart?"
        message="Your cart has buy items. Replace with this rental?"
        confirmText="Replace"
