...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', cast=Csv(), default='127.0.0.1,localhost,*.railway.app,*')
...
INSTALLED_APPS = [
    ...
    'core',             # Your app for users/items/transactions
]
...
ROOT_URLCONF = 'flairies_backend.urls'
...
WSGI_APPLICATION = 'flairies_backend.wsgi.application'
